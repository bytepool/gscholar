...
"""
Library to query ACM Digital Library.
...
def query(searchstr, outformat=FORMAT_BIBTEX, allresults=False):
    """Query ACM Digital Library.

    This method queries ACM Digitial Library and returns a list of citations.
    ...
    searchstr = '?query='+quote(searchstr)
    url = ACM_SEARCH_URL + searchstr
    header = HEADERS
